...
//        }
    ...
    func pressApplePay(){
        ...
        var shippitot = Double(self.total)
    
        
        if self.hasDiscountCode {
            shippitot = Double(self.total) - 5.00
        }
        ...
        request.paymentSummaryItems = [
            ...
            PKPaymentSummaryItem(label: "GroopCam", amount: NSDecimalNumber(value: shippitot  + 2.50))
        ]
